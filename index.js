// =================================================================
// Advanced Analytics Bot - v143.6 (Markdown Pipe Escape Fix)
// =================================================================
// --- IMPORTS ---
...
async function startBot() {
    ...
    try {
        ...
        await runDailyJobs();
        connectToOKXSocket();
        await bot.api.sendMessage(AUTHORIZED_USER_ID, "✅ *تم إعادة تشغيل البوت بنجاح \\(v143\\.6 \\- Markdown Pipe Escape Fix\\)*\n\n\\- تم إصلاح خطأ تنسيق الرسائل الذي كان يمنع عرض بعض التقارير\\.", { parse_mode: "MarkdownV2" }).catch(console.error);
    } catch (e) {
